...
public class Colorated {
    ...
    public static Color applyToColor(Interp interpolation, Color start, Color end, float v, Color res) {
        return res.set(
                interpolation.apply(start.r, end.r, v),
                interpolation.apply(start.g, end.g, v),
                interpolation.apply(start.b, end.b, v),
    ...
    public static Color applyToColor2(Interp interpolation, Color start, Color center, Color end, float v, Color res) {
        if (v >= 0.5f) {
            return applyToColor(interpolation, center, end, v, res);
        } else {
            return applyToColor(interpolation, start, center, v, res);
        }
    }
    ...
    public static Color applyToColor2(Interp interpolation, Color start, Color center, Color end, float v) {
        if (v >= 0.5f) {
            return applyToColor(interpolation, center, end, v);
        } else {
            return applyToColor(interpolation, start, center, v);
        }
    }
}
