...
public class SMenuRenderer extends mindustry.graphics.MenuRenderer {
    ...
    private void cache(){
        ...
        Core.batch = batch = new CacheBatch(new SspriteCache(width * height * 6, false));
        batch.beginCache();
